...
window.addEventListener("load", () => {
	const api =
		"https://api.sportsdata.io/v3/nfl/scores/json/Standings/2020?key=5f1041d6ef75463381916955e411731f";
	fetch(api)
		.then(response => {
...
function setstats(e) {
	const statsapi =
		"https://api.sportsdata.io/v3/nfl/scores/json/TeamSeasonStats/2020?key=5f1041d6ef75463381916955e411731f";
	fetch(statsapi)
		.then(response => {
			return response.json();
		})
